...
namespace ProjectPertemuan4MajuJaya
{
    class Pegawai
    {
        ...
        public ArrayList getPegawai() { return this.dataPegawai; } public ArrayList getStatus() { return this.dataStatus; }
        public ArrayList getKehadiran()
        {
        ...
        public bool Login(string username, string password)
        {
            ...
            if (this.notification == null)
            {
                ...
                this.notification = "Notification: Login sukses."; return true;
